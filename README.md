...
```text
https://github.com/TeamAcMong/Addressable-System.git#4.2.1
```
...
`4.2.1` is the current release of this line, and `4.1.0` was where the `-pre` label came off.
