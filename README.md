...
```text
https://github.com/TeamAcMong/Addressable-System.git#4.3.0
```
...
`4.3.0` is the current release of this line, and `4.1.0` was where the `-pre` label came off.
